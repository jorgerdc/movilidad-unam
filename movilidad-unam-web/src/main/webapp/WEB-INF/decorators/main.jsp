...
<link rel="stylesheet"
	href="<c:url value='/resources/css/skin-blue.min.css'/>">
<!-- Estilos generales del sistema-->
<link rel="stylesheet"
	href="<c:url value='/resources/css/movilidad.css'/>">
<!-- Google Font -->
<link rel="stylesheet"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="active" id="linkEstacion"><a href="<c:url value='/'/>"><i class="fa fa-map-marker"></i><span>Estaciones</span></a></li>
							
					<li id="linkPumabus"><a href="<c:url value='/pumabus'/>"><i class="fa fa-bus"></i> <span>Pumabus</span></a></li>
					
					<li id="linkRutas"><a href="<c:url value='/ruta'/>"><i class="fa fa-road"></i> <span>Rutas</span></a></li>
					
					<li id="linkEstacionamientos"><a href="<c:url value='/estacionamiento'/>"><i class="fa fa-car"></i> <span>Estacionamientos</span></a></li>
					
					<li id="linkUsuarios"><a href="<c:url value='/usuario'/>"><i class="fa fa-users"></i> <span>Usuarios</span></a></li>
